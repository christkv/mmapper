...
var buildSchemaObject = function(rules) {
  ...
  var SchemaObject = function(values, options) {
    ...
    for(var name in rules.fields) {
      ...
      set_up_property(this, values, name, rules.fields[name], dirtyFields, options);
    } 
    ...
    self.save = function(callback) {
      ...
      self.validate(function(err) {
        ...
        if(dirtyFields.length == 0 
            ...
            set_up_property(self, values, '_id', null, options);
            // Insert the document
  ...
  SchemaObject.findOne = function(selector, options, callback) {
    ...
    collection.findOne(selector, options, function(err, doc) {
      ...
      return callback(null, new SchemaObject(doc));
    });
  }
...
var executeUpdate = function(self, values, dirtyFields, collection, callback) {
  ...
  while(dirtyFields.length > 0) {
    ...
    if(field.op == '$set') {
      ...
      // selector[field.parent + "." + field.name + "._id"] = field._id;
...
var set_up_property = function(self, values, name, rule, dirtyFields, options) {
  if(Array.isArray(values[name])) 
    return set_up_array_property(self, values, name, rule, dirtyFields, options);
